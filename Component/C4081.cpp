...
C4081::C4081(const std::string &name) : Component::Component{name, "4081"}
{
    ...
    _internals[2]->SetLink(1, *this, 12, true);
    _internals[2]->SetLink(2, *this, 13, true);
    SetLink(11, *(_internals[2]), 3, true);
    _internals[3]->SetLink(1, *this, 8, true);
    _internals[3]->SetLink(2, *this, 9, true);
    SetLink(10, *(_internals[3]), 3, true);
}
